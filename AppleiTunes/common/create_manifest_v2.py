...
def write_manifest_file(p_load_id,p_folder,p_param_name,p_client="2222"):
    try:
      ...
      s3_folder = s3_folder + '/'+v_client+"/"+ provider + '/' + source_folder_name+ '/' + day_folder + subfolder_name + '/'
      print("s3_folder_manifest:",s3_folder_manifest)
      ...
      sub_folder_name = s3_folder.split("/")[3]
      manifest_file_name = s3_folder_manifest + provider + "_" + str(load_id) +'_' + sub_folder_name + '_' + day_folder + '.manifest'
